...
function App() {
  ...
  return (
    <div className="flex justify-center px-4">
      <div className="w-full md:w-3/4 lg:w-1/2 flex flex-col gap-4 my-8 bg-base-300 p-5 rounded-2xl">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <button onClick={addTodo} className="btn btn-primary w-full md:w-auto">
            Ajouter
          </button>
        </div>
        ...
        <div className="space-y-2 flex-1 h-fit">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <button
                className={`btn btn-soft ${filter === 'Terminées' ? 'btn-success' : ''}`}
            ...
            {/* Bouton suppression */}
            <button
              className="btn btn-error btn-soft w-full md:w-auto"
